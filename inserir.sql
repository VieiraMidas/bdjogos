...
insert into jogos (nome_jogo,descricao_jogo,genero_jogo,produtora_jogo) values ('Super Mario','','Ação','Top Games Kids');
...
insert into jogos (nome_jogo,descricao_jogo,genero_jogo,produtora_jogo) values ('Capitão América','','Ação','Top Games Kids');
select * from jogos;
...
insert into pessoa (tipopessoa_idtipopessoa,nome_pessoa,rg_pessoa,cpf_pessoa) values ('2','Alexandre Araújo','3597848-9','35765898777');
...
insert into endereco(tipolocal_idtipolocal,pessoa_idpessoa,logradouro,numero_endereco,complemento_endereco,bairro_endereco,cep_endereco,cidade_endereco,estado_endereco) values('3','1','Rua Demonte Risco','220','','Interlagos','04814-578','São Paulo','SP');

insert into endereco(tipolocal_idtipolocal,pessoa_idpessoa,logradouro,numero_endereco,complemento_endereco,bairro_endereco,cep_endereco,cidade_endereco,estado_endereco) values('3','2','Rua Nascimento de Moraes','51','','Grajaú','04922-510','São Paulo','SP');

insert into endereco(tipolocal_idtipolocal,pessoa_idpessoa,logradouro,numero_endereco,complemento_endereco,bairro_endereco,cep_endereco,cidade_endereco,estado_endereco) values('3','3','Praça Montes Claros','15','A','Progresso','04914-000','São Paulo','SP');

insert into endereco(tipolocal_idtipolocal,pessoa_idpessoa,logradouro,numero_endereco,complemento_endereco,bairro_endereco,cep_endereco,cidade_endereco,estado_endereco) values('3','4','Av. Primavera','1010','','Primavera','04010-100','São Paulo','SP');

insert into endereco(tipolocal_idtipolocal,pessoa_idpessoa,logradouro,numero_endereco,complemento_endereco,bairro_endereco,cep_endereco,cidade_endereco,estado_endereco) values('3','5','Rua Marinez','2','','Orion','04878-879','São Paulo','SP');
